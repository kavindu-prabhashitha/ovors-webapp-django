...
SECRET_KEY = 'django-insecure--!9rq!nnyzflxl#pfzw)+(kn^gypf)5li2tbv-aj-7_%0!@3)i'
...
INSTALLED_APPS = [
    ...
    'ovros_home.apps.OvrosHomeConfig',
    ...
    'ovros_report_module.apps.OvrosReportModuleConfig',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ovros_user_module.context_processors.profile_data',
            ],
        },
    },
]

WSGI_APPLICATION = 'ovros.wsgi.application'
